...
```bash
git clone https://github.com/dexon-foundation/remix-ide.git
git clone https://github.com/dexon-foundation/remix.git # only if you plan to link remix and remix-ide repositories and develop on it.
cd remix-ide
npm install
