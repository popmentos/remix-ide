...
module.exports = class SupportTab {
  constructor (localRegistry) {
    ...
    self._deps.app.event.register('tabChanged', (tabName) => {
      ...
      const iframe = yo`<iframe class="${css.chatIframe}" src='https://gitter.im/dexon-foundation/DApp/~embed'>`
    ...
    self._view.el = yo`
      <div class="${css.supportTabView}" id="supportView">
        <div class="${css.infoBox}">
          ...
          <a target="_blank" href='https://github.com/dexon-foundation/remix-ide/issues'> issues</a> or check out
